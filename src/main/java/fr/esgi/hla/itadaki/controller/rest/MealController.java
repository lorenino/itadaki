...
import fr.esgi.hla.itadaki.dto.meal.UpdateMealTypeRequestDto;
...
public class MealController {
    ...
    @SecurityRequirement(name = "bearerAuth")
    @Operation(summary = "Update the meal type (breakfast / lunch / snack / dinner)")
    public MealResponseDto updateMealType(@PathVariable Long id,
                                          @RequestBody @Valid UpdateMealTypeRequestDto request,
                                          @CurrentUser Long userId) {
        return mealService.updateMealType(id, request.mealType(), userId);
    }
}
